...
macro(include_army_package package)
	...
	foreach(definition ${${package}_definition})
		if(NOT EXISTS ${${package}_path}/${definition})
			message(FATAL_ERROR "${${package}_path}/${definition} does not exists" )
		endif()
...
# 		include(${${package}_path}/${${package}_definition})
		include(${${package}_path}/${definition})
		message("include ${definition} from ${package} (${${package}_path}/${definition})")
	endforeach()
